...
function Error() {
    return (
        <div className="bg-white xs:bg-gradient-one p-4 b-mob:p-12  b-mob:bg-gradient-two! md:bg-gradient-three flex flex-col min-h-screen items-center justify-center gap-[90px] max-w-screen-2xl mx-auto">
